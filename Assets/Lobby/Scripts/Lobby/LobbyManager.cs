...
namespace Prototype.NetworkLobby
{
    public class LobbyManager : NetworkLobbyManager
    {
        ...
        void Start()
        {
//            gamePlayerPrefab = gunner;
            playerPrefab = gamePlayerPrefab; // If something goes wrong: I added this (Sasha)
        ...
        public void setPrefab(int num)
        {
            gamePlayerPrefab = spawnPrefabs[num];
...
//            {
//                foreach (var lPlayer in lobbySlots)
//                {
//                    if (lPlayer == null) continue;
//                    var netID = lPlayer.GetComponent<NetworkIdentity>();
//                    Transform startPos = GetStartPosition();
//                    GameObject gamePlayer;
//                    if (startPos != null)
//                    {
//                        gamePlayer = (GameObject) Instantiate(spawnPrefabs[lPlayer.GetComponent<LobbyPlayer>().character], startPos.position, startPos.rotation);
//                    }
//                    else
//                    {
//                        gamePlayer = (GameObject) Instantiate(spawnPrefabs[lPlayer.GetComponent<LobbyPlayer>().character], Vector3.zero, Quaternion.identity);
//                    }
//
//                    var old = gamePlayer;
//                    OnLobbyServerSceneLoadedForPlayer(lPlayer.gameObject, gamePlayer);
//                    NetworkServer.ReplacePlayerForConnection(netID.connectionToClient,
//                        gamePlayer, netID.playerControllerId);
//                    
...
//
        public override GameObject OnLobbyServerCreateGamePlayer(NetworkConnection conn, short playerControllerId)
        {
            ...
            {
                Debug.LogError("More than 1 player on local connection.");
            }
